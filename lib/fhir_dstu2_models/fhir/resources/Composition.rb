  ...
  module DSTU2
    class Composition < FHIR::DSTU2::Model
      ...
      METADATA = {
        ...
        'confidentiality' => {'valid_codes'=>{'http://hl7.org/fhir/v3/Confidentiality'=>['_Confidentiality', 'L', 'M', 'N', 'R', 'U', 'V']}, 'type'=>'code', 'path'=>'Composition.confidentiality', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/v3-Confidentiality'}},
